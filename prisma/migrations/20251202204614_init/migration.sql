...
-- AddForeignKey
ALTER TABLE "ProductAccompaniment" ADD CONSTRAINT "ProductAccompaniment_productId_fkey" FOREIGN KEY ("productId") REFERENCES "Product"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
