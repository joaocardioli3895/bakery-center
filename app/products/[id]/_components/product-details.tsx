...
interface ProductDetailsProps {
  accompaniments: Prisma.ProductGetPayload<{
    include: {
      accompaniments: true;
    };
  }>;
  ...
  return (
    <>
      <div className="relative z-50 mt-[-1.5rem] rounded-tl-3xl rounded-tr-3xl bg-white py-5">
        ...
        {/*  NOME DO PRODUTO */}
        <h1 className="mb-3 px-5 text-xl font-semibold">{product.name}</h1>
        ...
        <Accordion type="single" collapsible className="w-full  space-y-3 px-5">
          ...
          <AccordionItem value="acc">
            ...
            <AccordionContent className="flex flex-col gap-2">
              {accompaniments.accompaniments.map((a) => (
        ...
        <div className="mt-6 px-5">
          <Button
            ...
            className="w-full bg-tematic font-semibold"
          >
            Adicionar á sacola
          </Button>
        </div>
